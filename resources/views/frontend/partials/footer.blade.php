            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h3 class="text-2xl font-bold text-white">Desa Cerdas</h3>
                ...
                {{-- Quick Links --}}
                <div class="space-y-6">
                    <h4 class="text-lg font-semibold text-white">Layanan Desa</h4>
                    <ul class="space-y-3">
                        <li>
                            <a href="{{ route('layanan.index') }}" class="footer-link">
                        ...
                        <li>
                            <a href="{{ route('forum.index') }}" class="footer-link">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <p class="text-gray-300 text-sm font-medium">Telepon</p>
                                <a href="tel:+62211234567" class="text-blue-300 hover:text-blue-200 text-sm transition-colors">(021) 1234-567</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <a href="mailto:info@desacerdas.id" class="text-blue-300 hover:text-blue-200 text-sm transition-colors">info@desacerdas.id</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <p class="text-gray-300 text-sm font-medium">Alamat</p>
                                <p class="text-gray-400 text-sm">Jl. Desa Cerdas No. 123</p>
                                <p class="text-gray-400 text-sm">Kecamatan Maju, Kabupaten Sejahtera</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <p class="text-gray-300 text-sm font-medium">Jam Layanan</p>
                ...
                <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    <div class="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
                        <p class="text-gray-400 text-sm">
                            &copy; {{ date('Y') }} Desa Cerdas. Semua hak dilindungi.
                        </p>
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <p class="text-gray-400 text-sm">untuk masyarakat desa</p>
                    </div>
                </div>
            </div>
        </div>
