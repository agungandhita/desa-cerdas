...
<div class="p-6">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-800">Tambah Berita</h1>
                <p class="text-slate-600 mt-1">Buat berita baru untuk desa</p>
            </div>
        </div>
    </div>
        ...
        <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <!-- Published At -->
                    <div class="bg-slate-50 p-4 rounded-lg" id="published_at_container" style="display: none;">
            ...
            <div class="flex justify-end gap-4 mt-8 pt-6 border-t border-slate-200">
                <a href="{{ route('admin.berita.index') }}" class="px-6 py-2 border border-slate-300 text-slate-700 rounded-lg hover:bg-slate-50 transition-colors duration-200">
                    Batal
                </a>
